      ...
      Authorization: {
        ...
        custom: {
          options: async (value: string, { req }) => {
            const acccess_token = value.split(' ')[1]
            if (!acccess_token) {
        ...
        custom: {
          options: async (value: string, { req }) => {
            ...
            try {
              ...
              //sau khi verify ta đc payload của email_verify_token: decoded_email_verify_token
        ...
        custom: {
          options: async (value: string, { req }) => {
            ...
            try {
              ...
              //sau khi verify ta đc payload của email_verify_token: decoded_email_verify_token
              ;(req as Request).decoded_email_verify_token = decoded_forgot_password_token
